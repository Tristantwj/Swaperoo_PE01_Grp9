    ...
    public partial class fin : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "2bf0d5d5-7691-418f-b2f7-266c7467a0b0", 0, "bf4513ec-4f16-4ef7-a55b-8bf621661ef7", "frankofoedu@blazor.com", true, false, null, null, "FRANKOFOEDU@BLAZOR.COM", "FRANKOFOEDU@BLAZOR.COM", "AQAAAAIAAYagAAAAEGwq5lyriouSg5yNmI4GBdE48gOcEBsl4rSVGuQUWZlz7KUULZUe5ZcYyID+Q/pIRg==", null, false, null, "d894040f-3021-46d4-907e-b3a6939eca64", false, "frankofoedu@blazor.com" },
                    { "2bf0d5d5-7691-418f-b2f7-266c7467a0b1", 0, "b908fdb3-28e4-4cc2-8b83-872bf1219d4c", "john@blazor.com", true, false, null, null, "JOHN@BLAZOR.COM", "JOHN@BLAZOR.COM", "AQAAAAIAAYagAAAAEPV6U7g1WI4BP0JNB5m+u6g2b8nbkTZLcLjFtSZdSlnHMifqL8KZCs9hxinArbO3WA==", null, false, null, "a27e7616-756a-4c4a-a179-e2baa9a7e8a2", false, "john@blazor.com" },
                    { "2bf0d5d5-7691-418f-b2f7-266c7467a0b2", 0, "48860899-d321-4218-994c-578f8f9eff2a", "alice@blazor.com", true, false, null, null, "ALICE@BLAZOR.COM", "ALICE@BLAZOR.COM", "AQAAAAIAAYagAAAAEI138I3HXkwCieYPFlFKTNFvbgBW0SXUs9IE+oggS/7sqPOK6GfFD2Ef/KfQwspzHA==", null, false, null, "b261150b-ba6e-4a6d-b66f-389109d52ab6", false, "alice@blazor.com" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2024, 1, 26, 10, 55, 58, 260, DateTimeKind.Local).AddTicks(938), "Description", null, "site", null, null, "2bf0d5d5-7691-418f-b2f7-266c7467a0b0", null, "unsolved" });

            migrationBuilder.InsertData(
                table: "Swaps",
                columns: new[] { "Id", "BuyerId", "OfferItemID", "ProductId", "SellertId", "SwapDate", "SwapProductId", "UserId" },
                values: new object[] { 1, "2bf0d5d5-7691-418f-b2f7-266c7467a0b0", 3, null, "2bf0d5d5-7691-418f-b2f7-266c7467a0b1", new DateTime(2024, 1, 26, 10, 55, 58, 260, DateTimeKind.Local).AddTicks(1614), 4, null });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 2, new DateTime(2024, 1, 26, 10, 55, 58, 259, DateTimeKind.Local).AddTicks(8028), "Test Swap Chat", null, 1 });

            migrationBuilder.InsertData(
                table: "Purchases",
                columns: new[] { "Id", "OfferPrice", "ProductId", "PurchaseProductId", "SellDate", "UserId" },
                values: new object[] { 1, 400.0, null, 2, new DateTime(2024, 1, 26, 10, 55, 58, 260, DateTimeKind.Local).AddTicks(266), "2bf0d5d5-7691-418f-b2f7-266c7467a0b1" });
            ...
            migrationBuilder.InsertData(
                table: "Chats",
                columns: new[] { "Id", "DateCreated", "Name", "PurchaseId", "SwapId" },
                values: new object[] { 1, new DateTime(2024, 1, 26, 10, 55, 58, 259, DateTimeKind.Local).AddTicks(7998), "Test Purchase Chat", 1, null });
