    ...
    public partial class fin : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "2bf0d5d5-7691-418f-b2f7-266c7467a0b0", 0, "0e6cba97-a8f4-48c1-80cb-01ef95915b53", "frank@blazor.com", true, false, null, null, "FRANK@BLAZOR.COM", "FRANK@BLAZOR.COM", "AQAAAAIAAYagAAAAEEaS8laE5i61vssQ5SyMpf69c78ShdeqahQX6wCJp4hypxZoZ3lT1lLd8BELm2adJg==", null, false, null, "9728fd6f-0c4a-45d8-b6d1-a1e210e7efe5", false, "frank@blazor.com" },
                    { "2bf0d5d5-7691-418f-b2f7-266c7467a0b1", 0, "40cecbee-8a4e-4914-9536-0dcf1b7812d4", "john@blazor.com", true, false, null, null, "JOHN@BLAZOR.COM", "JOHN@BLAZOR.COM", "AQAAAAIAAYagAAAAEM3ME3+lWrSQBKCeQo7YYwRPDLKr0WAU1hi8pRUOeLLErn0ED7hsXVnN77wl6lp8hw==", null, false, null, "1d5fc5b4-899c-4910-bb65-f8e89768bc6d", false, "john@blazor.com" },
                    { "2bf0d5d5-7691-418f-b2f7-266c7467a0b2", 0, "cab38898-ec13-48d6-96c7-b8ae6f120317", "alice@blazor.com", true, false, null, null, "ALICE@BLAZOR.COM", "ALICE@BLAZOR.COM", "AQAAAAIAAYagAAAAEMsURAW11UbdBJAWl6YHtVp/ejtLpmJ7cyd3TXoDQqx81xZKax92Herw5LF5qvLjlg==", null, false, null, "dd59e533-8694-43c6-b325-cddca21f99c1", false, "alice@blazor.com" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 2, 1, 2, 18, 45, 150, DateTimeKind.Local).AddTicks(7093), new DateTime(2024, 2, 1, 2, 18, 45, 150, DateTimeKind.Local).AddTicks(7095), "empty", "frank@blazor.com", "Frank", "North", "User", "2bf0d5d5-7691-418f-b2f7-266c7467a0b0", "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png" },
                    { 2, new DateTime(2024, 2, 1, 2, 18, 45, 150, DateTimeKind.Local).AddTicks(7097), new DateTime(2024, 2, 1, 2, 18, 45, 150, DateTimeKind.Local).AddTicks(7097), "empty", "john@blazor.com", "John", "South", "User", "2bf0d5d5-7691-418f-b2f7-266c7467a0b1", "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png" },
                    { 3, new DateTime(2024, 2, 1, 2, 18, 45, 150, DateTimeKind.Local).AddTicks(7099), new DateTime(2024, 2, 1, 2, 18, 45, 150, DateTimeKind.Local).AddTicks(7100), "empty", "alice@blazor.com", "Alice", "West", "Admin", "2bf0d5d5-7691-418f-b2f7-266c7467a0b2", "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png" }
                });

            migrationBuilder.InsertData(
                table: "Reports",
                columns: new[] { "Id", "DateCreated", "Description", "ProductId", "ReportType", "ReportedProductId", "ReportedUserId", "ReporterUserId", "status" },
                values: new object[] { 1, new DateTime(2024, 2, 1, 2, 18, 45, 150, DateTimeKind.Local).AddTicks(8027), "Description", null, "site", null, null, 1, "unsolved" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 2, 1, 2, 18, 45, 150, DateTimeKind.Local).AddTicks(5903), "Test Purchase Chat", 1, null },
                    { 2, new DateTime(2024, 2, 1, 2, 18, 45, 150, DateTimeKind.Local).AddTicks(5930), "Test Swap Chat", null, 1 }
                });

            migrationBuilder.InsertData(
                table: "Ratings",
                columns: new[] { "Id", "DateCreated", "Description", "PurchaseId", "RatingValue", "SwapId", "UserId" },
                values: new object[] { 1, new DateTime(2024, 2, 1, 2, 18, 45, 150, DateTimeKind.Local).AddTicks(7715), "blahblah", 1, 4, null, 1 });

            migrationBuilder.InsertData(
                table: "Messages",
                columns: new[] { "Id", "ChatId", "DateCreated", "MessageContent", "SenderId" },
                values: new object[] { 1, 1, new DateTime(2024, 2, 1, 2, 18, 45, 150, DateTimeKind.Local).AddTicks(6276), "Fashion", 1 });
