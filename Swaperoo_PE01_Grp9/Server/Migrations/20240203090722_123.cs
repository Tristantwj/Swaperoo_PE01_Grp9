    ...
    public partial class _123 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "2bf0d5d5-7691-418f-b2f7-266c7467a0b0", 0, "2434a240-f607-4974-b385-f6a96c6c8049", "frank@blazor.com", true, false, null, "FRANK@BLAZOR.COM", "FRANK@BLAZOR.COM", "AQAAAAIAAYagAAAAEIHcTx8bZnx+GCwos6esDFg9R8OO1w0Xwtq7xM+2lMB/luthLOw7J+tiHdm6yZe5Qw==", null, false, "c0f87b17-f22c-4331-a2d1-3d2501f65714", false, "frank@blazor.com" },
                    { "2bf0d5d5-7691-418f-b2f7-266c7467a0b1", 0, "98d66111-f5a6-45d5-8895-d7b2a3526efe", "john@blazor.com", true, false, null, "JOHN@BLAZOR.COM", "JOHN@BLAZOR.COM", "AQAAAAIAAYagAAAAEKSZMFvFUvqvYTtQ+uCi4uLQxyi5aHvOXStvrYlB7d4Wvpn6MQnNWRh2SzKhKfqCeg==", null, false, "7a45b27c-90ab-4522-987a-82c53619293a", false, "john@blazor.com" },
                    { "2bf0d5d5-7691-418f-b2f7-266c7467a0b2", 0, "64103a3e-2210-402f-826a-b94a4181fd6b", "alice@blazor.com", true, false, null, "ALICE@BLAZOR.COM", "ALICE@BLAZOR.COM", "AQAAAAIAAYagAAAAEI59IRH/kvsBw3ZSMl2Qzf7gAhyEZn5UxFGoA9gH9RD+QLWd1vD41yd/Dd5PkHJbuA==", null, false, "3e118750-665d-42f2-88ce-d96664d31dd8", false, "alice@blazor.com" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 2, 3, 17, 7, 22, 70, DateTimeKind.Local).AddTicks(4897), new DateTime(2024, 2, 3, 17, 7, 22, 70, DateTimeKind.Local).AddTicks(4898), "empty", "frank@blazor.com", "Frank", "North", "User", "2bf0d5d5-7691-418f-b2f7-266c7467a0b0", "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png" },
                    { 2, new DateTime(2024, 2, 3, 17, 7, 22, 70, DateTimeKind.Local).AddTicks(4899), new DateTime(2024, 2, 3, 17, 7, 22, 70, DateTimeKind.Local).AddTicks(4899), "empty", "john@blazor.com", "John", "South", "User", "2bf0d5d5-7691-418f-b2f7-266c7467a0b1", "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png" },
                    { 3, new DateTime(2024, 2, 3, 17, 7, 22, 70, DateTimeKind.Local).AddTicks(4901), new DateTime(2024, 2, 3, 17, 7, 22, 70, DateTimeKind.Local).AddTicks(4901), "empty", "alice@blazor.com", "Alice", "West", "Admin", "2bf0d5d5-7691-418f-b2f7-266c7467a0b2", "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png" }
                });

            migrationBuilder.InsertData(
                table: "Reports",
                columns: new[] { "Id", "DateCreated", "Description", "ProductId", "ReportType", "ReportedProductId", "ReportedUserId", "ReporterUserId", "status" },
                values: new object[] { 1, new DateTime(2024, 2, 3, 17, 7, 22, 70, DateTimeKind.Local).AddTicks(5498), "Description", null, "site", null, null, 1, "unsolved" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 2, 3, 17, 7, 22, 70, DateTimeKind.Local).AddTicks(4332), "Test Purchase Chat", 1, null },
                    { 2, new DateTime(2024, 2, 3, 17, 7, 22, 70, DateTimeKind.Local).AddTicks(4345), "Test Swap Chat", null, 1 }
                });

            migrationBuilder.InsertData(
                table: "Ratings",
                columns: new[] { "Id", "DateCreated", "Description", "PurchaseId", "RatingValue", "SwapId", "UserId" },
                values: new object[] { 1, new DateTime(2024, 2, 3, 17, 7, 22, 70, DateTimeKind.Local).AddTicks(5292), "blahblah", 1, 4, null, 1 });

            migrationBuilder.InsertData(
                table: "Messages",
                columns: new[] { "Id", "ChatId", "DateCreated", "MessageContent", "SenderId" },
                values: new object[] { 1, 1, new DateTime(2024, 2, 3, 17, 7, 22, 70, DateTimeKind.Local).AddTicks(4588), "Fashion", 1 });
