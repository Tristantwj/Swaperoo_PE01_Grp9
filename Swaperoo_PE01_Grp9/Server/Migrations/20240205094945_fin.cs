    ...
    public partial class fin : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "2bf0d5d5-7691-418f-b2f7-266c7467a0b0", 0, "b5ff1946-b93b-4525-be80-70c8a8cd8185", "frank@blazor.com", true, false, null, "FRANK@BLAZOR.COM", "FRANK@BLAZOR.COM", "AQAAAAIAAYagAAAAECZ5+NIipuVvyTvp1zhcFKt2oIQ3oaDFxxXGIM9DamycDfPxb3EJjHy9+9CK7mvn8w==", null, false, "afcb1ee1-92ec-4c77-bc9a-8e863cbfd8f0", false, "frank@blazor.com" },
                    { "2bf0d5d5-7691-418f-b2f7-266c7467a0b1", 0, "0e140f9d-697d-408b-b130-dc09ec68ccd4", "john@blazor.com", true, false, null, "JOHN@BLAZOR.COM", "JOHN@BLAZOR.COM", "AQAAAAIAAYagAAAAEAjAj34w7SSnEe1zO2nW/p0tQe0drSYJpfj22vmV4i8+Pndd/AQf8dncg4rnxXX5ig==", null, false, "0613c56d-87a2-4525-bf63-ec9090b2c7da", false, "john@blazor.com" },
                    { "2bf0d5d5-7691-418f-b2f7-266c7467a0b2", 0, "8cfbe0c0-9b3a-4305-9c7b-c081753449e4", "alice@blazor.com", true, false, null, "ALICE@BLAZOR.COM", "ALICE@BLAZOR.COM", "AQAAAAIAAYagAAAAEKGDK6grxoL6CiFaBJFlO2HT3P9Myf6B8GaTbcb5nmXfcQ1+Q3uLP4mMIqRzgvfhzw==", null, false, "b61e9dad-5eb1-429f-8bfb-6ac958a005d7", false, "alice@blazor.com" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 2, 5, 17, 49, 45, 98, DateTimeKind.Local).AddTicks(8133), new DateTime(2024, 2, 5, 17, 49, 45, 98, DateTimeKind.Local).AddTicks(8138), "empty", "frank@blazor.com", "Frank", "North", "Admin", "2bf0d5d5-7691-418f-b2f7-266c7467a0b0", "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png" },
                    { 2, new DateTime(2024, 2, 5, 17, 49, 45, 98, DateTimeKind.Local).AddTicks(8155), new DateTime(2024, 2, 5, 17, 49, 45, 98, DateTimeKind.Local).AddTicks(8157), "empty", "john@blazor.com", "John", "South", "User", "2bf0d5d5-7691-418f-b2f7-266c7467a0b1", "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png" },
                    { 3, new DateTime(2024, 2, 5, 17, 49, 45, 98, DateTimeKind.Local).AddTicks(8163), new DateTime(2024, 2, 5, 17, 49, 45, 98, DateTimeKind.Local).AddTicks(8164), "empty", "alice@blazor.com", "Alice", "West", "Admin", "2bf0d5d5-7691-418f-b2f7-266c7467a0b2", "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png" }
                });

            migrationBuilder.InsertData(
                table: "Reports",
                columns: new[] { "Id", "DateCreated", "Description", "ProductId", "ReportType", "ReportedProductId", "ReportedUserId", "ReporterUserId", "status" },
                values: new object[] { 1, new DateTime(2024, 2, 5, 17, 49, 45, 98, DateTimeKind.Local).AddTicks(9879), "Description", null, "site", null, null, 1, "unsolved" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 2, 5, 17, 49, 45, 98, DateTimeKind.Local).AddTicks(6329), "Test Purchase Chat", 1, null },
                    { 2, new DateTime(2024, 2, 5, 17, 49, 45, 98, DateTimeKind.Local).AddTicks(6352), "Test Swap Chat", null, 1 }
                });

            migrationBuilder.InsertData(
                table: "Ratings",
                columns: new[] { "Id", "DateCreated", "Description", "PurchaseId", "RatingValue", "SwapId", "UserId" },
                values: new object[] { 1, new DateTime(2024, 2, 5, 17, 49, 45, 98, DateTimeKind.Local).AddTicks(9329), "blahblah", 1, 4, null, 1 });

            migrationBuilder.InsertData(
                table: "Messages",
                columns: new[] { "Id", "ChatId", "DateCreated", "MessageContent", "SenderId" },
                values: new object[] { 1, 1, new DateTime(2024, 2, 5, 17, 49, 45, 98, DateTimeKind.Local).AddTicks(6932), "Fashion", 1 });
