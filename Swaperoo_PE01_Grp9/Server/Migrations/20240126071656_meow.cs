    ...
    public partial class meow : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "2bf0d5d5-7691-418f-b2f7-266c7467a0b0", 0, "16e387e4-0a54-471b-aa1d-413fa1931641", "frankofoedu@blazor.com", true, false, null, null, "FRANKOFOEDU@BLAZOR.COM", "FRANKOFOEDU@BLAZOR.COM", "AQAAAAIAAYagAAAAEIl6RRNor6GyX+waMnAXueUHo3+cY0d4gZpcQPlBpJaLd994vIZSG4jnVoEIOJWwvA==", null, false, null, "6022c4b2-cdd6-4683-82ed-e7cedba9d522", false, "frankofoedu@blazor.com" },
                    { "2bf0d5d5-7691-418f-b2f7-266c7467a0b1", 0, "3a4c17d9-7935-4fd5-bfc2-a3fbc7adfa94", "john@blazor.com", true, false, null, null, "JOHN@BLAZOR.COM", "JOHN@BLAZOR.COM", "AQAAAAIAAYagAAAAEJVLEfc7Witj4nRScI3V1pvh/ASPT72VPukyW2DUzI8dbm+GqVP9L6trdEFS8NzfBQ==", null, false, null, "65b9fb59-341c-469d-8c21-c3f4c1184e8b", false, "john@blazor.com" },
                    { "2bf0d5d5-7691-418f-b2f7-266c7467a0b2", 0, "4abfb4f9-f180-4bc6-8c89-9fdd5dcbddeb", "alice@blazor.com", true, false, null, null, "ALICE@BLAZOR.COM", "ALICE@BLAZOR.COM", "AQAAAAIAAYagAAAAEFwZsXir2nmG1L/LIJu+h+RahBN6NsBld2Yazq7fKYAxvuDmJqP+OHdtb+M7OIOZlA==", null, false, null, "7f12c842-9538-47ab-b2fb-b54c9d7de4d7", false, "alice@blazor.com" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2024, 1, 26, 15, 16, 56, 672, DateTimeKind.Local).AddTicks(6812), "Description", null, "site", null, null, "2bf0d5d5-7691-418f-b2f7-266c7467a0b0", "unsolved" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 1, 26, 15, 16, 56, 672, DateTimeKind.Local).AddTicks(5643), "Test Purchase Chat", 1, null },
                    { 2, new DateTime(2024, 1, 26, 15, 16, 56, 672, DateTimeKind.Local).AddTicks(5654), "Test Swap Chat", null, 1 }
                });

            migrationBuilder.InsertData(
                table: "Ratings",
                columns: new[] { "Id", "DateCreated", "Description", "PurchaseId", "RatingValue", "SwapId", "UserId" },
                values: new object[] { 1, new DateTime(2024, 1, 26, 15, 16, 56, 672, DateTimeKind.Local).AddTicks(6634), "blahblah", 1, 4, null, "2bf0d5d5-7691-418f-b2f7-266c7467a0b0" });

            migrationBuilder.InsertData(
                table: "Messages",
                columns: new[] { "Id", "ChatId", "DateCreated", "MessageContent", "SenderId" },
                values: new object[] { 1, 1, new DateTime(2024, 1, 26, 15, 16, 56, 672, DateTimeKind.Local).AddTicks(5889), "Fashion", "2bf0d5d5-7691-418f-b2f7-266c7467a0b0" });
