...
{
    /// <inheritdoc />
    public partial class finfin : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "2bf0d5d5-7691-418f-b2f7-266c7467a0b0", 0, "6b1108a8-0bb7-4f1c-a262-b0fb2d5e15ff", "frankofoedu@blazor.com", true, false, null, null, "FRANKOFOEDU@BLAZOR.COM", "FRANKOFOEDU@BLAZOR.COM", "AQAAAAIAAYagAAAAEFM39VuM3wz726InB5XEjKuzSXdTEZnX0oUPX/5sdxRAX6hIHYGK+lFX3OMs6LItPg==", null, false, null, "0dfbacf2-c5d0-4919-be5f-17913b4d771d", false, "frankofoedu@blazor.com" },
                    { "2bf0d5d5-7691-418f-b2f7-266c7467a0b1", 0, "cd97ae3d-3dd1-4885-a956-4faf24923293", "john@blazor.com", true, false, null, null, "JOHN@BLAZOR.COM", "JOHN@BLAZOR.COM", "AQAAAAIAAYagAAAAEJ27y7XnPapO7dZiXZuw+pWljNIpiixYncQ50YylhqReLSWOjSvXGN9K+WjlpLri2g==", null, false, null, "91971b2e-6664-42ae-aab6-041da768b770", false, "john@blazor.com" },
                    { "2bf0d5d5-7691-418f-b2f7-266c7467a0b2", 0, "2eb1ada5-34a1-498a-a247-ebfbb11afb12", "alice@blazor.com", true, false, null, null, "ALICE@BLAZOR.COM", "ALICE@BLAZOR.COM", "AQAAAAIAAYagAAAAEIlzAk7q9prTVI4JQKw6cb6Hx40SstnYwpuH8dkVFIQVKmFzR0VL6CqmupOM2pAcSw==", null, false, null, "f34a17be-d0b8-48c5-814e-f27e9d0293e4", false, "alice@blazor.com" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2024, 1, 26, 15, 50, 6, 468, DateTimeKind.Local).AddTicks(7743), "Description", null, "site", null, null, "2bf0d5d5-7691-418f-b2f7-266c7467a0b0", "unsolved" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 1, 26, 15, 50, 6, 468, DateTimeKind.Local).AddTicks(5634), "Test Purchase Chat", 1, null },
                    { 2, new DateTime(2024, 1, 26, 15, 50, 6, 468, DateTimeKind.Local).AddTicks(5664), "Test Swap Chat", null, 1 }
                });

            migrationBuilder.InsertData(
                table: "Ratings",
                columns: new[] { "Id", "DateCreated", "Description", "PurchaseId", "RatingValue", "SwapId", "UserId" },
                values: new object[] { 1, new DateTime(2024, 1, 26, 15, 50, 6, 468, DateTimeKind.Local).AddTicks(7350), "blahblah", 1, 4, null, "2bf0d5d5-7691-418f-b2f7-266c7467a0b0" });

            migrationBuilder.InsertData(
                table: "Messages",
                columns: new[] { "Id", "ChatId", "DateCreated", "MessageContent", "SenderId" },
                values: new object[] { 1, 1, new DateTime(2024, 1, 26, 15, 50, 6, 468, DateTimeKind.Local).AddTicks(5990), "Fashion", "2bf0d5d5-7691-418f-b2f7-266c7467a0b0" });
