    ...
    public partial class _123 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "2bf0d5d5-7691-418f-b2f7-266c7467a0b0", 0, "24624698-f3e1-4813-9799-e99cb1459ded", "frank@blazor.com", true, false, null, "FRANK@BLAZOR.COM", "FRANK@BLAZOR.COM", "AQAAAAIAAYagAAAAEHfzZgc3hr1Bv724b7F81Wy1iDPMRLJMW6fhlzsx7ts0CUEIkJULAfsbCp0TslqRUg==", null, false, "ffc2dfe4-d12a-4fae-a2ea-699b1d100891", false, "frank@blazor.com" },
                    { "2bf0d5d5-7691-418f-b2f7-266c7467a0b1", 0, "dcecc48d-afa7-449a-a498-8cfd5c732c4e", "john@blazor.com", true, false, null, "JOHN@BLAZOR.COM", "JOHN@BLAZOR.COM", "AQAAAAIAAYagAAAAEKTTDCs/eP/BQyB6cUwtJmDEVHrUSxhLuhVyF6e/7jb73+8EBW/uTuADgFo02W7A4w==", null, false, "8c45811c-226a-4239-8100-da130233d285", false, "john@blazor.com" },
                    { "2bf0d5d5-7691-418f-b2f7-266c7467a0b2", 0, "59fd4532-e1e4-4e7d-99fb-99ace0f5cbb8", "alice@blazor.com", true, false, null, "ALICE@BLAZOR.COM", "ALICE@BLAZOR.COM", "AQAAAAIAAYagAAAAEAynP0g+Xnwyzt5QrAhCj15UDOw7C+F/0H75NWvcrptrVacFWXgjmgi9LccVblFW3g==", null, false, "4dc9c552-b75d-41fd-b582-fdeb1d34255d", false, "alice@blazor.com" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 2, 4, 23, 26, 53, 750, DateTimeKind.Local).AddTicks(9752), new DateTime(2024, 2, 4, 23, 26, 53, 750, DateTimeKind.Local).AddTicks(9755), "empty", "frank@blazor.com", "Frank", "North", "User", "2bf0d5d5-7691-418f-b2f7-266c7467a0b0", "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png" },
                    { 2, new DateTime(2024, 2, 4, 23, 26, 53, 750, DateTimeKind.Local).AddTicks(9758), new DateTime(2024, 2, 4, 23, 26, 53, 750, DateTimeKind.Local).AddTicks(9759), "empty", "john@blazor.com", "John", "South", "User", "2bf0d5d5-7691-418f-b2f7-266c7467a0b1", "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png" },
                    { 3, new DateTime(2024, 2, 4, 23, 26, 53, 750, DateTimeKind.Local).AddTicks(9760), new DateTime(2024, 2, 4, 23, 26, 53, 750, DateTimeKind.Local).AddTicks(9760), "empty", "alice@blazor.com", "Alice", "West", "Admin", "2bf0d5d5-7691-418f-b2f7-266c7467a0b2", "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png" }
                });

            migrationBuilder.InsertData(
                table: "Reports",
                columns: new[] { "Id", "DateCreated", "Description", "ProductId", "ReportType", "ReportedProductId", "ReportedUserId", "ReporterUserId", "status" },
                values: new object[] { 1, new DateTime(2024, 2, 4, 23, 26, 53, 751, DateTimeKind.Local).AddTicks(174), "Description", null, "site", null, null, 1, "unsolved" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 2, 4, 23, 26, 53, 750, DateTimeKind.Local).AddTicks(9298), "Test Purchase Chat", 1, null },
                    { 2, new DateTime(2024, 2, 4, 23, 26, 53, 750, DateTimeKind.Local).AddTicks(9311), "Test Swap Chat", null, 1 }
                });

            migrationBuilder.InsertData(
                table: "Ratings",
                columns: new[] { "Id", "DateCreated", "Description", "PurchaseId", "RatingValue", "SwapId", "UserId" },
                values: new object[] { 1, new DateTime(2024, 2, 4, 23, 26, 53, 751, DateTimeKind.Local).AddTicks(33), "blahblah", 1, 4, null, 1 });

            migrationBuilder.InsertData(
                table: "Messages",
                columns: new[] { "Id", "ChatId", "DateCreated", "MessageContent", "SenderId" },
                values: new object[] { 1, 1, new DateTime(2024, 2, 4, 23, 26, 53, 750, DateTimeKind.Local).AddTicks(9457), "Fashion", 1 });
