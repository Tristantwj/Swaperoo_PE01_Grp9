    ...
    public partial class _123 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "2bf0d5d5-7691-418f-b2f7-266c7467a0b0", 0, "410aeb9e-7076-426a-8d2a-dc90202b3bfa", "frank@blazor.com", true, false, null, "FRANK@BLAZOR.COM", "FRANK@BLAZOR.COM", "AQAAAAIAAYagAAAAEMWwzWjFrqpwkwv9x3b+TdnFCGhA9+LDNH0Dymlou+LE+7Hjoil+540VJa7NT+2UsQ==", null, false, "008f3bc3-be05-4d73-bc4a-29ea189d9ee2", false, "frank@blazor.com" },
                    { "2bf0d5d5-7691-418f-b2f7-266c7467a0b1", 0, "17d9a843-8aba-4d40-8930-263e448ea689", "john@blazor.com", true, false, null, "JOHN@BLAZOR.COM", "JOHN@BLAZOR.COM", "AQAAAAIAAYagAAAAEAegqMoKEivcslKi1U7nlzmnvpliMq0T/j3C7HWaRLqr+jwEvTsDtqakwnKNAFBQOQ==", null, false, "0051fe2b-4d49-43ac-917d-1c22b9ffdf1e", false, "john@blazor.com" },
                    { "2bf0d5d5-7691-418f-b2f7-266c7467a0b2", 0, "912e1f33-88a8-4ec2-a880-6ef10696a069", "alice@blazor.com", true, false, null, "ALICE@BLAZOR.COM", "ALICE@BLAZOR.COM", "AQAAAAIAAYagAAAAEGs9xJNxRq6G9hsSSFqvv9rlKCB9fD52eWXjeyWzyLMRpsREc4R7w/s+1WiP9e5WoA==", null, false, "64a1ae1a-8de1-4ac7-b1e6-5adbf35ce16e", false, "alice@blazor.com" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 2, 5, 0, 0, 35, 655, DateTimeKind.Local).AddTicks(2393), new DateTime(2024, 2, 5, 0, 0, 35, 655, DateTimeKind.Local).AddTicks(2395), "empty", "frank@blazor.com", "Frank", "North", "Admin", "2bf0d5d5-7691-418f-b2f7-266c7467a0b0", "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png" },
                    { 2, new DateTime(2024, 2, 5, 0, 0, 35, 655, DateTimeKind.Local).AddTicks(2397), new DateTime(2024, 2, 5, 0, 0, 35, 655, DateTimeKind.Local).AddTicks(2398), "empty", "john@blazor.com", "John", "South", "User", "2bf0d5d5-7691-418f-b2f7-266c7467a0b1", "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png" },
                    { 3, new DateTime(2024, 2, 5, 0, 0, 35, 655, DateTimeKind.Local).AddTicks(2399), new DateTime(2024, 2, 5, 0, 0, 35, 655, DateTimeKind.Local).AddTicks(2400), "empty", "alice@blazor.com", "Alice", "West", "Admin", "2bf0d5d5-7691-418f-b2f7-266c7467a0b2", "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png" }
                });

            migrationBuilder.InsertData(
                table: "Reports",
                columns: new[] { "Id", "DateCreated", "Description", "ProductId", "ReportType", "ReportedProductId", "ReportedUserId", "ReporterUserId", "status" },
                values: new object[] { 1, new DateTime(2024, 2, 5, 0, 0, 35, 655, DateTimeKind.Local).AddTicks(2878), "Description", null, "site", null, null, 1, "unsolved" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 2, 5, 0, 0, 35, 655, DateTimeKind.Local).AddTicks(1937), "Test Purchase Chat", 1, null },
                    { 2, new DateTime(2024, 2, 5, 0, 0, 35, 655, DateTimeKind.Local).AddTicks(1950), "Test Swap Chat", null, 1 }
                });

            migrationBuilder.InsertData(
                table: "Ratings",
                columns: new[] { "Id", "DateCreated", "Description", "PurchaseId", "RatingValue", "SwapId", "UserId" },
                values: new object[] { 1, new DateTime(2024, 2, 5, 0, 0, 35, 655, DateTimeKind.Local).AddTicks(2740), "blahblah", 1, 4, null, 1 });

            migrationBuilder.InsertData(
                table: "Messages",
                columns: new[] { "Id", "ChatId", "DateCreated", "MessageContent", "SenderId" },
                values: new object[] { 1, 1, new DateTime(2024, 2, 5, 0, 0, 35, 655, DateTimeKind.Local).AddTicks(2086), "Fashion", 1 });
