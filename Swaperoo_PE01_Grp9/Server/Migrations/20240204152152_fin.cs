    ...
    public partial class fin : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "2bf0d5d5-7691-418f-b2f7-266c7467a0b0", 0, "2b19c631-56a8-4d69-8d4d-3f42ad373610", "frank@blazor.com", true, false, null, "FRANK@BLAZOR.COM", "FRANK@BLAZOR.COM", "AQAAAAIAAYagAAAAEH2kNBYKdSFdBOZJic50tebZCTiiQx9/v9Mzy44O19gwpvX/dSNpAK+t26MAQa4mfA==", null, false, "ff975af4-d00c-4767-9eec-ea7c2270adc4", false, "frank@blazor.com" },
                    { "2bf0d5d5-7691-418f-b2f7-266c7467a0b1", 0, "7b24b6f0-a009-466a-aab0-65ab385e06e8", "john@blazor.com", true, false, null, "JOHN@BLAZOR.COM", "JOHN@BLAZOR.COM", "AQAAAAIAAYagAAAAEODCURvdNUV2WwFdylxchFBLaF3roc2gwiiRT5sOswWZP7+6C4FyAJVy8n33rpxlug==", null, false, "0c59ab55-eace-43e5-b990-e81ffe5ed7c5", false, "john@blazor.com" },
                    { "2bf0d5d5-7691-418f-b2f7-266c7467a0b2", 0, "6fd03c75-67ae-4b49-9039-ff98f7c2c41c", "alice@blazor.com", true, false, null, "ALICE@BLAZOR.COM", "ALICE@BLAZOR.COM", "AQAAAAIAAYagAAAAEEhdhLYER0B5xnXkx8QVJcAdsLlPcCZsd4hAbIGOMb4roi7zghkeoqP7FbbPpapcsw==", null, false, "9c570980-e15e-4037-8d4c-438ee3a6db79", false, "alice@blazor.com" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 2, 4, 23, 21, 52, 295, DateTimeKind.Local).AddTicks(688), new DateTime(2024, 2, 4, 23, 21, 52, 295, DateTimeKind.Local).AddTicks(697), "empty", "frank@blazor.com", "Frank", "North", "User", "2bf0d5d5-7691-418f-b2f7-266c7467a0b0", "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png" },
                    { 2, new DateTime(2024, 2, 4, 23, 21, 52, 295, DateTimeKind.Local).AddTicks(718), new DateTime(2024, 2, 4, 23, 21, 52, 295, DateTimeKind.Local).AddTicks(719), "empty", "john@blazor.com", "John", "South", "User", "2bf0d5d5-7691-418f-b2f7-266c7467a0b1", "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png" },
                    { 3, new DateTime(2024, 2, 4, 23, 21, 52, 295, DateTimeKind.Local).AddTicks(723), new DateTime(2024, 2, 4, 23, 21, 52, 295, DateTimeKind.Local).AddTicks(724), "empty", "alice@blazor.com", "Alice", "West", "Admin", "2bf0d5d5-7691-418f-b2f7-266c7467a0b2", "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png" }
                });

            migrationBuilder.InsertData(
                table: "Reports",
                columns: new[] { "Id", "DateCreated", "Description", "ProductId", "ReportType", "ReportedProductId", "ReportedUserId", "ReporterUserId", "status" },
                values: new object[] { 1, new DateTime(2024, 2, 4, 23, 21, 52, 295, DateTimeKind.Local).AddTicks(2936), "Description", null, "site", null, null, 1, "unsolved" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 2, 4, 23, 21, 52, 294, DateTimeKind.Local).AddTicks(8382), "Test Purchase Chat", 1, null },
                    { 2, new DateTime(2024, 2, 4, 23, 21, 52, 294, DateTimeKind.Local).AddTicks(8465), "Test Swap Chat", null, 1 }
                });

            migrationBuilder.InsertData(
                table: "Ratings",
                columns: new[] { "Id", "DateCreated", "Description", "PurchaseId", "RatingValue", "SwapId", "UserId" },
                values: new object[] { 1, new DateTime(2024, 2, 4, 23, 21, 52, 295, DateTimeKind.Local).AddTicks(2212), "blahblah", 1, 4, null, 1 });

            migrationBuilder.InsertData(
                table: "Messages",
                columns: new[] { "Id", "ChatId", "DateCreated", "MessageContent", "SenderId" },
                values: new object[] { 1, 1, new DateTime(2024, 2, 4, 23, 21, 52, 294, DateTimeKind.Local).AddTicks(9208), "Fashion", 1 });
