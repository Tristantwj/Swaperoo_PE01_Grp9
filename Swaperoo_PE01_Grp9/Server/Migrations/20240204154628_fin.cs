    ...
    public partial class fin : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "2bf0d5d5-7691-418f-b2f7-266c7467a0b0", 0, "36c655e6-460d-49e9-894d-09cf5b8da0fe", "frank@blazor.com", true, false, null, "FRANK@BLAZOR.COM", "FRANK@BLAZOR.COM", "AQAAAAIAAYagAAAAEAPEIs2N6eZDtrZ5c0P7L1BmWTflWcjo9mp+94+q2n75oL4KQoTM2yuVTUs7cImDtA==", null, false, "c82f948c-fd99-48ea-adb9-ecad0e38450c", false, "frank@blazor.com" },
                    { "2bf0d5d5-7691-418f-b2f7-266c7467a0b1", 0, "53af3df9-0db1-4797-989c-c27f1b2068a8", "john@blazor.com", true, false, null, "JOHN@BLAZOR.COM", "JOHN@BLAZOR.COM", "AQAAAAIAAYagAAAAEENNmaeUrFwIDSlMhx4axr76b0aVmZf2sJG3RkHR05ter6o6VelS6ZEBZmfXMHAb2g==", null, false, "686054a5-b228-457e-9578-e855f80ee2f9", false, "john@blazor.com" },
                    { "2bf0d5d5-7691-418f-b2f7-266c7467a0b2", 0, "6bf3cefb-427e-4726-bedd-3632f9f60af7", "alice@blazor.com", true, false, null, "ALICE@BLAZOR.COM", "ALICE@BLAZOR.COM", "AQAAAAIAAYagAAAAEDzSpvEljwrzP+OLpC8qhVqwfsc0bsLtoiwsaDwYJeIZjuPetGJKbJBavY/y8ACEUw==", null, false, "9e352529-e246-41ba-9e62-c0da9c0bd809", false, "alice@blazor.com" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 2, 4, 23, 46, 28, 69, DateTimeKind.Local).AddTicks(6271), new DateTime(2024, 2, 4, 23, 46, 28, 69, DateTimeKind.Local).AddTicks(6280), "empty", "frank@blazor.com", "Frank", "North", "Admin", "2bf0d5d5-7691-418f-b2f7-266c7467a0b0", "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png" },
                    { 2, new DateTime(2024, 2, 4, 23, 46, 28, 69, DateTimeKind.Local).AddTicks(6300), new DateTime(2024, 2, 4, 23, 46, 28, 69, DateTimeKind.Local).AddTicks(6301), "empty", "john@blazor.com", "John", "South", "User", "2bf0d5d5-7691-418f-b2f7-266c7467a0b1", "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png" },
                    { 3, new DateTime(2024, 2, 4, 23, 46, 28, 69, DateTimeKind.Local).AddTicks(6305), new DateTime(2024, 2, 4, 23, 46, 28, 69, DateTimeKind.Local).AddTicks(6307), "empty", "alice@blazor.com", "Alice", "West", "Admin", "2bf0d5d5-7691-418f-b2f7-266c7467a0b2", "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png" }
                });

            migrationBuilder.InsertData(
                table: "Reports",
                columns: new[] { "Id", "DateCreated", "Description", "ProductId", "ReportType", "ReportedProductId", "ReportedUserId", "ReporterUserId", "status" },
                values: new object[] { 1, new DateTime(2024, 2, 4, 23, 46, 28, 69, DateTimeKind.Local).AddTicks(9164), "Description", null, "site", null, null, 1, "unsolved" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 2, 4, 23, 46, 28, 69, DateTimeKind.Local).AddTicks(3616), "Test Purchase Chat", 1, null },
                    { 2, new DateTime(2024, 2, 4, 23, 46, 28, 69, DateTimeKind.Local).AddTicks(3708), "Test Swap Chat", null, 1 }
                });

            migrationBuilder.InsertData(
                table: "Ratings",
                columns: new[] { "Id", "DateCreated", "Description", "PurchaseId", "RatingValue", "SwapId", "UserId" },
                values: new object[] { 1, new DateTime(2024, 2, 4, 23, 46, 28, 69, DateTimeKind.Local).AddTicks(8183), "blahblah", 1, 4, null, 1 });

            migrationBuilder.InsertData(
                table: "Messages",
                columns: new[] { "Id", "ChatId", "DateCreated", "MessageContent", "SenderId" },
                values: new object[] { 1, 1, new DateTime(2024, 2, 4, 23, 46, 28, 69, DateTimeKind.Local).AddTicks(4485), "Fashion", 1 });
