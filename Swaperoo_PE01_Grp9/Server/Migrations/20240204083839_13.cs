    ...
    public partial class _13 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "2bf0d5d5-7691-418f-b2f7-266c7467a0b0", 0, "aee8c6fc-46be-4b03-94c7-318ab505fb28", "frank@blazor.com", true, false, null, "FRANK@BLAZOR.COM", "FRANK@BLAZOR.COM", "AQAAAAIAAYagAAAAEMZzq4wKR6pltw8ysWetYEcWI0nv8rCq7JYbfCejnLyzzPILZgD1fLIkzipgfeO91w==", null, false, "7aa124c0-33fa-4b87-b2ac-05631aaf5899", false, "frank@blazor.com" },
                    { "2bf0d5d5-7691-418f-b2f7-266c7467a0b1", 0, "4b3449b8-b8c3-4fbb-806e-a583a3685fd0", "john@blazor.com", true, false, null, "JOHN@BLAZOR.COM", "JOHN@BLAZOR.COM", "AQAAAAIAAYagAAAAEC+6OBq01UjmUFyangCvxgq20z5IxoyAV4G51ELLMprWKWj2JUdpXAMd8+HbL/GcVQ==", null, false, "bac10aca-e20f-48b9-a39f-0f0169bab578", false, "john@blazor.com" },
                    { "2bf0d5d5-7691-418f-b2f7-266c7467a0b2", 0, "37cfcd69-b309-4fda-a429-ca1a65f3d8b9", "alice@blazor.com", true, false, null, "ALICE@BLAZOR.COM", "ALICE@BLAZOR.COM", "AQAAAAIAAYagAAAAEL9c0kd2hO3FQHK2xUsEevmG3H2KKd6AzsHn1WNyGV6P0N2Gc3yhvvkXpyABVvbheA==", null, false, "8903e25d-4685-4ad3-b1d2-b0750138a4bc", false, "alice@blazor.com" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 2, 4, 16, 38, 39, 300, DateTimeKind.Local).AddTicks(4801), new DateTime(2024, 2, 4, 16, 38, 39, 300, DateTimeKind.Local).AddTicks(4802), "empty", "frank@blazor.com", "Frank", "North", "User", "2bf0d5d5-7691-418f-b2f7-266c7467a0b0", "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png" },
                    { 2, new DateTime(2024, 2, 4, 16, 38, 39, 300, DateTimeKind.Local).AddTicks(4803), new DateTime(2024, 2, 4, 16, 38, 39, 300, DateTimeKind.Local).AddTicks(4804), "empty", "john@blazor.com", "John", "South", "User", "2bf0d5d5-7691-418f-b2f7-266c7467a0b1", "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png" },
                    { 3, new DateTime(2024, 2, 4, 16, 38, 39, 300, DateTimeKind.Local).AddTicks(4805), new DateTime(2024, 2, 4, 16, 38, 39, 300, DateTimeKind.Local).AddTicks(4806), "empty", "alice@blazor.com", "Alice", "West", "Admin", "2bf0d5d5-7691-418f-b2f7-266c7467a0b2", "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png" }
                });

            migrationBuilder.InsertData(
                table: "Reports",
                columns: new[] { "Id", "DateCreated", "Description", "ProductId", "ReportType", "ReportedProductId", "ReportedUserId", "ReporterUserId", "status" },
                values: new object[] { 1, new DateTime(2024, 2, 4, 16, 38, 39, 300, DateTimeKind.Local).AddTicks(5647), "Description", null, "site", null, null, 1, "unsolved" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 2, 4, 16, 38, 39, 300, DateTimeKind.Local).AddTicks(4173), "Test Purchase Chat", 1, null },
                    { 2, new DateTime(2024, 2, 4, 16, 38, 39, 300, DateTimeKind.Local).AddTicks(4188), "Test Swap Chat", null, 1 }
                });

            migrationBuilder.InsertData(
                table: "Ratings",
                columns: new[] { "Id", "DateCreated", "Description", "PurchaseId", "RatingValue", "SwapId", "UserId" },
                values: new object[] { 1, new DateTime(2024, 2, 4, 16, 38, 39, 300, DateTimeKind.Local).AddTicks(5321), "blahblah", 1, 4, null, 1 });

            migrationBuilder.InsertData(
                table: "Messages",
                columns: new[] { "Id", "ChatId", "DateCreated", "MessageContent", "SenderId" },
                values: new object[] { 1, 1, new DateTime(2024, 2, 4, 16, 38, 39, 300, DateTimeKind.Local).AddTicks(4440), "Fashion", 1 });
