    ...
    public partial class _123 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "2bf0d5d5-7691-418f-b2f7-266c7467a0b0", 0, "be09d435-3b49-469d-96a5-dcada9c06628", "frank@blazor.com", true, false, null, "FRANK@BLAZOR.COM", "FRANK@BLAZOR.COM", "AQAAAAIAAYagAAAAEJp//ST9t+Kn3ps10sR2tlchbrX2g6JFX8V4nYsOyFNfjvU52mQjeYoX1EfJQHsmuQ==", null, false, "50fc27b2-a094-44d7-84b2-5c9b6e2dc627", false, "frank@blazor.com" },
                    { "2bf0d5d5-7691-418f-b2f7-266c7467a0b1", 0, "147e7433-1b41-4180-a508-289c8bdfff30", "john@blazor.com", true, false, null, "JOHN@BLAZOR.COM", "JOHN@BLAZOR.COM", "AQAAAAIAAYagAAAAEGILt98jmWfFYRGkwyyZGcwsN3jojGUzet9xR0xxMVEy5i8UQxbZ3sUCHRe6NcrUyw==", null, false, "3e9ab7bc-c337-451b-8a43-44ff74c12dac", false, "john@blazor.com" },
                    { "2bf0d5d5-7691-418f-b2f7-266c7467a0b2", 0, "55e756f1-1d01-4f60-bd16-e5aa70ac3acc", "alice@blazor.com", true, false, null, "ALICE@BLAZOR.COM", "ALICE@BLAZOR.COM", "AQAAAAIAAYagAAAAEC0z+GDc6dyYuHgpbtPUzy+fN71V+JBCItRtJ/QvO6dMSPO+Vqyhili/tnYZggtmXQ==", null, false, "28e588da-dff6-4866-9456-28ff8cfa1ee0", false, "alice@blazor.com" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 2, 5, 14, 32, 6, 538, DateTimeKind.Local).AddTicks(4767), new DateTime(2024, 2, 5, 14, 32, 6, 538, DateTimeKind.Local).AddTicks(4769), "empty", "frank@blazor.com", "Frank", "North", "Admin", "2bf0d5d5-7691-418f-b2f7-266c7467a0b0", "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png" },
                    { 2, new DateTime(2024, 2, 5, 14, 32, 6, 538, DateTimeKind.Local).AddTicks(4771), new DateTime(2024, 2, 5, 14, 32, 6, 538, DateTimeKind.Local).AddTicks(4771), "empty", "john@blazor.com", "John", "South", "User", "2bf0d5d5-7691-418f-b2f7-266c7467a0b1", "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png" },
                    { 3, new DateTime(2024, 2, 5, 14, 32, 6, 538, DateTimeKind.Local).AddTicks(4773), new DateTime(2024, 2, 5, 14, 32, 6, 538, DateTimeKind.Local).AddTicks(4773), "empty", "alice@blazor.com", "Alice", "West", "Admin", "2bf0d5d5-7691-418f-b2f7-266c7467a0b2", "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png" }
                });

            migrationBuilder.InsertData(
                table: "Reports",
                columns: new[] { "Id", "DateCreated", "Description", "ProductId", "ReportType", "ReportedProductId", "ReportedUserId", "ReporterUserId", "status" },
                values: new object[] { 1, new DateTime(2024, 2, 5, 14, 32, 6, 538, DateTimeKind.Local).AddTicks(5414), "Description", null, "site", null, null, 1, "unsolved" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 2, 5, 14, 32, 6, 538, DateTimeKind.Local).AddTicks(3821), "Test Purchase Chat", 1, null },
                    { 2, new DateTime(2024, 2, 5, 14, 32, 6, 538, DateTimeKind.Local).AddTicks(3831), "Test Swap Chat", null, 1 }
                });

            migrationBuilder.InsertData(
                table: "Ratings",
                columns: new[] { "Id", "DateCreated", "Description", "PurchaseId", "RatingValue", "SwapId", "UserId" },
                values: new object[] { 1, new DateTime(2024, 2, 5, 14, 32, 6, 538, DateTimeKind.Local).AddTicks(5143), "blahblah", 1, 4, null, 1 });

            migrationBuilder.InsertData(
                table: "Messages",
                columns: new[] { "Id", "ChatId", "DateCreated", "MessageContent", "SenderId" },
                values: new object[] { 1, 1, new DateTime(2024, 2, 5, 14, 32, 6, 538, DateTimeKind.Local).AddTicks(4055), "Fashion", 1 });
