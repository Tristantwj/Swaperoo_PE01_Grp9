    ...
    public partial class fin : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "2bf0d5d5-7691-418f-b2f7-266c7467a0b0", 0, "19d8ef67-b7a5-4b4c-9da5-8572bc75dbdd", "frank@blazor.com", true, false, null, "FRANK@BLAZOR.COM", "FRANK@BLAZOR.COM", "AQAAAAIAAYagAAAAELmU67oNY84OlcNrFS6/LNNETpp4E8zTu4rD/ibi3pOIm4FAgjDi6HNqyGu2VBtV0A==", null, false, "1040285b-781b-4985-be1f-c90fe91dba25", false, "frank@blazor.com" },
                    { "2bf0d5d5-7691-418f-b2f7-266c7467a0b1", 0, "173ecab5-012d-4084-a574-b081ef242e56", "john@blazor.com", true, false, null, "JOHN@BLAZOR.COM", "JOHN@BLAZOR.COM", "AQAAAAIAAYagAAAAEO+chS+1pbCqQXdtxW5GjRZKawtfSnMQ+E45OaXyOjfJf/Clp8oYpS5DY/gNQvhX1w==", null, false, "5605892d-cebe-4f76-82d7-6c920041d4d6", false, "john@blazor.com" },
                    { "2bf0d5d5-7691-418f-b2f7-266c7467a0b2", 0, "034bfc40-96c8-40a7-9cb8-fa472b8325f3", "alice@blazor.com", true, false, null, "ALICE@BLAZOR.COM", "ALICE@BLAZOR.COM", "AQAAAAIAAYagAAAAEHoURnElid5gdIzt9dn0y5GyeUK76xi6WOHGWiCdIBYy+XZbKn+H4wbypKzHDiYUWA==", null, false, "4d67d322-ea20-4dbe-aa2e-9872ae59b4c9", false, "alice@blazor.com" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 2, 3, 14, 16, 27, 405, DateTimeKind.Local).AddTicks(953), new DateTime(2024, 2, 3, 14, 16, 27, 405, DateTimeKind.Local).AddTicks(955), "empty", "frank@blazor.com", "Frank", "North", "User", "2bf0d5d5-7691-418f-b2f7-266c7467a0b0", "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png" },
                    { 2, new DateTime(2024, 2, 3, 14, 16, 27, 405, DateTimeKind.Local).AddTicks(958), new DateTime(2024, 2, 3, 14, 16, 27, 405, DateTimeKind.Local).AddTicks(958), "empty", "john@blazor.com", "John", "South", "User", "2bf0d5d5-7691-418f-b2f7-266c7467a0b1", "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png" },
                    { 3, new DateTime(2024, 2, 3, 14, 16, 27, 405, DateTimeKind.Local).AddTicks(960), new DateTime(2024, 2, 3, 14, 16, 27, 405, DateTimeKind.Local).AddTicks(961), "empty", "alice@blazor.com", "Alice", "West", "Admin", "2bf0d5d5-7691-418f-b2f7-266c7467a0b2", "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png" }
                });

            migrationBuilder.InsertData(
                table: "Reports",
                columns: new[] { "Id", "DateCreated", "Description", "ProductId", "ReportType", "ReportedProductId", "ReportedUserId", "ReporterUserId", "status" },
                values: new object[] { 1, new DateTime(2024, 2, 3, 14, 16, 27, 405, DateTimeKind.Local).AddTicks(2084), "Description", null, "site", null, null, 1, "unsolved" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 2, 3, 14, 16, 27, 404, DateTimeKind.Local).AddTicks(9418), "Test Purchase Chat", 1, null },
                    { 2, new DateTime(2024, 2, 3, 14, 16, 27, 404, DateTimeKind.Local).AddTicks(9455), "Test Swap Chat", null, 1 }
                });

            migrationBuilder.InsertData(
                table: "Ratings",
                columns: new[] { "Id", "DateCreated", "Description", "PurchaseId", "RatingValue", "SwapId", "UserId" },
                values: new object[] { 1, new DateTime(2024, 2, 3, 14, 16, 27, 405, DateTimeKind.Local).AddTicks(1687), "blahblah", 1, 4, null, 1 });

            migrationBuilder.InsertData(
                table: "Messages",
                columns: new[] { "Id", "ChatId", "DateCreated", "MessageContent", "SenderId" },
                values: new object[] { 1, 1, new DateTime(2024, 2, 3, 14, 16, 27, 404, DateTimeKind.Local).AddTicks(9800), "Fashion", 1 });
