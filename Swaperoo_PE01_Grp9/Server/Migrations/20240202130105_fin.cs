    ...
    public partial class fin : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "2bf0d5d5-7691-418f-b2f7-266c7467a0b0", 0, "7cfd6394-9ed6-4e0a-9e1f-4f8488eb749e", "frank@blazor.com", true, false, null, null, "FRANK@BLAZOR.COM", "FRANK@BLAZOR.COM", "AQAAAAIAAYagAAAAEBW4YilpQN6vpiFp8PlwjJsv9tS9N1tm3EtAp6nZhkpmUjCHfvad8cVRk951JFMA8Q==", null, false, null, "9e446aae-ddf8-4596-8069-a106237b5d06", false, "frank@blazor.com" },
                    { "2bf0d5d5-7691-418f-b2f7-266c7467a0b1", 0, "30caf728-3935-42fa-aea2-b473b98d99c4", "john@blazor.com", true, false, null, null, "JOHN@BLAZOR.COM", "JOHN@BLAZOR.COM", "AQAAAAIAAYagAAAAEMm5qQ56TLsuoNPAPtAEOtw7p0IncwvQ4jVwBB31CeT5XBybCpHvSEOw3MdQTHejaQ==", null, false, null, "9f9e369b-e578-4c8b-92b8-caf4c91e8fe3", false, "john@blazor.com" },
                    { "2bf0d5d5-7691-418f-b2f7-266c7467a0b2", 0, "956c0573-7bab-4cbc-966a-bb546cb3b874", "alice@blazor.com", true, false, null, null, "ALICE@BLAZOR.COM", "ALICE@BLAZOR.COM", "AQAAAAIAAYagAAAAEJGCHtwAzGSYMC7D3onueJaskCfcqY5JfQyX3i7ufUiSDVj9tQitukv5mc0eYxDL9w==", null, false, null, "61c348af-f3f9-4e9f-b511-6cddbd686a21", false, "alice@blazor.com" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 2, 2, 21, 1, 5, 716, DateTimeKind.Local).AddTicks(2679), new DateTime(2024, 2, 2, 21, 1, 5, 716, DateTimeKind.Local).AddTicks(2683), "empty", "frank@blazor.com", "Frank", "North", "User", "2bf0d5d5-7691-418f-b2f7-266c7467a0b0", "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png" },
                    { 2, new DateTime(2024, 2, 2, 21, 1, 5, 716, DateTimeKind.Local).AddTicks(2685), new DateTime(2024, 2, 2, 21, 1, 5, 716, DateTimeKind.Local).AddTicks(2686), "empty", "john@blazor.com", "John", "South", "User", "2bf0d5d5-7691-418f-b2f7-266c7467a0b1", "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png" },
                    { 3, new DateTime(2024, 2, 2, 21, 1, 5, 716, DateTimeKind.Local).AddTicks(2688), new DateTime(2024, 2, 2, 21, 1, 5, 716, DateTimeKind.Local).AddTicks(2688), "empty", "alice@blazor.com", "Alice", "West", "Admin", "2bf0d5d5-7691-418f-b2f7-266c7467a0b2", "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png" }
                });

            migrationBuilder.InsertData(
                table: "Reports",
                columns: new[] { "Id", "DateCreated", "Description", "ProductId", "ReportType", "ReportedProductId", "ReportedUserId", "ReporterUserId", "status" },
                values: new object[] { 1, new DateTime(2024, 2, 2, 21, 1, 5, 716, DateTimeKind.Local).AddTicks(4368), "Description", null, "site", null, null, 1, "unsolved" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 2, 2, 21, 1, 5, 716, DateTimeKind.Local).AddTicks(793), "Test Purchase Chat", 1, null },
                    { 2, new DateTime(2024, 2, 2, 21, 1, 5, 716, DateTimeKind.Local).AddTicks(819), "Test Swap Chat", null, 1 }
                });

            migrationBuilder.InsertData(
                table: "Ratings",
                columns: new[] { "Id", "DateCreated", "Description", "PurchaseId", "RatingValue", "SwapId", "UserId" },
                values: new object[] { 1, new DateTime(2024, 2, 2, 21, 1, 5, 716, DateTimeKind.Local).AddTicks(3550), "blahblah", 1, 4, null, 1 });

            migrationBuilder.InsertData(
                table: "Messages",
                columns: new[] { "Id", "ChatId", "DateCreated", "MessageContent", "SenderId" },
                values: new object[] { 1, 1, new DateTime(2024, 2, 2, 21, 1, 5, 716, DateTimeKind.Local).AddTicks(1131), "Fashion", 1 });
