    ...
    public partial class fin : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "2bf0d5d5-7691-418f-b2f7-266c7467a0b0", 0, "958a2597-bd99-48d3-9419-488a2fadd183", "frank@blazor.com", true, false, null, "FRANK@BLAZOR.COM", "FRANK@BLAZOR.COM", "AQAAAAIAAYagAAAAELoerh6oahu7/xr5g2qMxu/glVe67U5Ug9Gu3MlD1CuFG5mvxZPCYHbZX4vd8eaL4w==", null, false, "e5b494dd-ba66-47ce-94d9-d2fc9971a761", false, "frank@blazor.com" },
                    { "2bf0d5d5-7691-418f-b2f7-266c7467a0b1", 0, "62d8960b-b35d-4391-beae-752d05716764", "john@blazor.com", true, false, null, "JOHN@BLAZOR.COM", "JOHN@BLAZOR.COM", "AQAAAAIAAYagAAAAEM57TxEiJ9zOlhgzjtsFkYWxtmcyUqDlae5JnCOhJEHEnDIdYQn9KMS0/RJYZKVBoA==", null, false, "5babb559-b7ef-4f86-ad8c-6b90106aee67", false, "john@blazor.com" },
                    { "2bf0d5d5-7691-418f-b2f7-266c7467a0b2", 0, "a20663a8-0fc6-4253-9f3b-3aaf413b4931", "alice@blazor.com", true, false, null, "ALICE@BLAZOR.COM", "ALICE@BLAZOR.COM", "AQAAAAIAAYagAAAAEFVZO3rq9BMkO+6ajIo7JPkGOdYVCXwvoHnM9s0VxaHWS4jE/+lAlOFmNPMIld4ovQ==", null, false, "819b5019-2b59-4ebc-9ac1-261e7c6cb5fc", false, "alice@blazor.com" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 2, 4, 22, 15, 24, 901, DateTimeKind.Local).AddTicks(8104), new DateTime(2024, 2, 4, 22, 15, 24, 901, DateTimeKind.Local).AddTicks(8106), "empty", "frank@blazor.com", "Frank", "North", "User", "2bf0d5d5-7691-418f-b2f7-266c7467a0b0", "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png" },
                    { 2, new DateTime(2024, 2, 4, 22, 15, 24, 901, DateTimeKind.Local).AddTicks(8109), new DateTime(2024, 2, 4, 22, 15, 24, 901, DateTimeKind.Local).AddTicks(8110), "empty", "john@blazor.com", "John", "South", "User", "2bf0d5d5-7691-418f-b2f7-266c7467a0b1", "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png" },
                    { 3, new DateTime(2024, 2, 4, 22, 15, 24, 901, DateTimeKind.Local).AddTicks(8111), new DateTime(2024, 2, 4, 22, 15, 24, 901, DateTimeKind.Local).AddTicks(8112), "empty", "alice@blazor.com", "Alice", "West", "Admin", "2bf0d5d5-7691-418f-b2f7-266c7467a0b2", "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png" }
                });

            migrationBuilder.InsertData(
                table: "Reports",
                columns: new[] { "Id", "DateCreated", "Description", "ProductId", "ReportType", "ReportedProductId", "ReportedUserId", "ReporterUserId", "status" },
                values: new object[] { 1, new DateTime(2024, 2, 4, 22, 15, 24, 901, DateTimeKind.Local).AddTicks(9048), "Description", null, "site", null, null, 1, "unsolved" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 2, 4, 22, 15, 24, 901, DateTimeKind.Local).AddTicks(6427), "Test Purchase Chat", 1, null },
                    { 2, new DateTime(2024, 2, 4, 22, 15, 24, 901, DateTimeKind.Local).AddTicks(6453), "Test Swap Chat", null, 1 }
                });

            migrationBuilder.InsertData(
                table: "Ratings",
                columns: new[] { "Id", "DateCreated", "Description", "PurchaseId", "RatingValue", "SwapId", "UserId" },
                values: new object[] { 1, new DateTime(2024, 2, 4, 22, 15, 24, 901, DateTimeKind.Local).AddTicks(8757), "blahblah", 1, 4, null, 1 });

            migrationBuilder.InsertData(
                table: "Messages",
                columns: new[] { "Id", "ChatId", "DateCreated", "MessageContent", "SenderId" },
                values: new object[] { 1, 1, new DateTime(2024, 2, 4, 22, 15, 24, 901, DateTimeKind.Local).AddTicks(6781), "Fashion", 1 });
