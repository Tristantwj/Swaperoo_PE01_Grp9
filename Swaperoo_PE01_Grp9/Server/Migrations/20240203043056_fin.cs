    ...
    public partial class fin : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "2bf0d5d5-7691-418f-b2f7-266c7467a0b0", 0, "86350287-75f2-4f17-ab9b-e18b8f456f81", "frank@blazor.com", true, false, null, "FRANK@BLAZOR.COM", "FRANK@BLAZOR.COM", "AQAAAAIAAYagAAAAEKuU772ovYyw1G8bXtuQtr1DvOnHm8PCdaIGSfCbWlGTb3P+jBcvmRXTveoQSA1D6Q==", null, false, "20c961fd-0dc9-45be-80b3-a6124b2a8aef", false, "frank@blazor.com" },
                    { "2bf0d5d5-7691-418f-b2f7-266c7467a0b1", 0, "0c72d22f-1b27-4f8a-a391-2f5c7e517ab6", "john@blazor.com", true, false, null, "JOHN@BLAZOR.COM", "JOHN@BLAZOR.COM", "AQAAAAIAAYagAAAAEAAjikuvUnbORWxIqjbKXJiVlMdQm34K7GaXd5llo7dUMWT9D2VDfsEOkTFDqCCxgg==", null, false, "8f794b64-ffdf-4310-a88d-1ebec1c659d2", false, "john@blazor.com" },
                    { "2bf0d5d5-7691-418f-b2f7-266c7467a0b2", 0, "f14a978e-0188-4524-ae06-47cb436d1c19", "alice@blazor.com", true, false, null, "ALICE@BLAZOR.COM", "ALICE@BLAZOR.COM", "AQAAAAIAAYagAAAAEJgKHPJSXlwmUkcguq7hwSt3+Lc+5/wvnNRH4nZLL8VWlqU6QWV8yyTqSg1f3EStmg==", null, false, "88ee54f2-c18f-47e8-921d-59b103bbbcde", false, "alice@blazor.com" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 2, 3, 12, 30, 56, 55, DateTimeKind.Local).AddTicks(314), new DateTime(2024, 2, 3, 12, 30, 56, 55, DateTimeKind.Local).AddTicks(316), "empty", "frank@blazor.com", "Frank", "North", "User", "2bf0d5d5-7691-418f-b2f7-266c7467a0b0", "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png" },
                    { 2, new DateTime(2024, 2, 3, 12, 30, 56, 55, DateTimeKind.Local).AddTicks(318), new DateTime(2024, 2, 3, 12, 30, 56, 55, DateTimeKind.Local).AddTicks(318), "empty", "john@blazor.com", "John", "South", "User", "2bf0d5d5-7691-418f-b2f7-266c7467a0b1", "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png" },
                    { 3, new DateTime(2024, 2, 3, 12, 30, 56, 55, DateTimeKind.Local).AddTicks(320), new DateTime(2024, 2, 3, 12, 30, 56, 55, DateTimeKind.Local).AddTicks(320), "empty", "alice@blazor.com", "Alice", "West", "Admin", "2bf0d5d5-7691-418f-b2f7-266c7467a0b2", "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png" }
                });

            migrationBuilder.InsertData(
                table: "Reports",
                columns: new[] { "Id", "DateCreated", "Description", "ProductId", "ReportType", "ReportedProductId", "ReportedUserId", "ReporterUserId", "status" },
                values: new object[] { 1, new DateTime(2024, 2, 3, 12, 30, 56, 55, DateTimeKind.Local).AddTicks(1647), "Description", null, "site", null, null, 1, "unsolved" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 2, 3, 12, 30, 56, 54, DateTimeKind.Local).AddTicks(9080), "Test Purchase Chat", 1, null },
                    { 2, new DateTime(2024, 2, 3, 12, 30, 56, 54, DateTimeKind.Local).AddTicks(9104), "Test Swap Chat", null, 1 }
                });

            migrationBuilder.InsertData(
                table: "Ratings",
                columns: new[] { "Id", "DateCreated", "Description", "PurchaseId", "RatingValue", "SwapId", "UserId" },
                values: new object[] { 1, new DateTime(2024, 2, 3, 12, 30, 56, 55, DateTimeKind.Local).AddTicks(1222), "blahblah", 1, 4, null, 1 });

            migrationBuilder.InsertData(
                table: "Messages",
                columns: new[] { "Id", "ChatId", "DateCreated", "MessageContent", "SenderId" },
                values: new object[] { 1, 1, new DateTime(2024, 2, 3, 12, 30, 56, 54, DateTimeKind.Local).AddTicks(9471), "Fashion", 1 });
