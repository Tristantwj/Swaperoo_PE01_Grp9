    ...
    public partial class fin : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "2bf0d5d5-7691-418f-b2f7-266c7467a0b0", 0, "d50c46dc-924f-4e58-90c6-62bd1f9cbea6", "frank@blazor.com", true, false, null, "FRANK@BLAZOR.COM", "FRANK@BLAZOR.COM", "AQAAAAIAAYagAAAAEKRk/pDFiMPLIPREZpLoezB7rGhFWo6ohrTzuJWyvKoN4fRIZSg9EISYTuLUJWqaiA==", null, false, "d368ffcf-5bb3-432a-b662-1d7394a902db", false, "frank@blazor.com" },
                    { "2bf0d5d5-7691-418f-b2f7-266c7467a0b1", 0, "fce4feac-7bef-4b58-b328-df22b053a546", "john@blazor.com", true, false, null, "JOHN@BLAZOR.COM", "JOHN@BLAZOR.COM", "AQAAAAIAAYagAAAAEHq1z3+fxhGyeGbwo7PRdW3PmXh/weYZKBTv1O3DNGEa90VLhL1f4zqC0UjeWFM45g==", null, false, "429e537b-e70c-4d04-9793-27c8619cdfaa", false, "john@blazor.com" },
                    { "2bf0d5d5-7691-418f-b2f7-266c7467a0b2", 0, "c1eec0a8-6ca2-459e-8609-e3d6099fc3a9", "alice@blazor.com", true, false, null, "ALICE@BLAZOR.COM", "ALICE@BLAZOR.COM", "AQAAAAIAAYagAAAAELs5LUKNTk80UeqiRfFQDEqtP6KSxPL5w/DFaU2iwRGTRVRkC3+xyu7qFafc4VAOkw==", null, false, "a778e1b6-29ac-4d11-91ea-4701e4695fcc", false, "alice@blazor.com" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 2, 5, 13, 42, 2, 858, DateTimeKind.Local).AddTicks(4673), new DateTime(2024, 2, 5, 13, 42, 2, 858, DateTimeKind.Local).AddTicks(4678), "empty", "frank@blazor.com", "Frank", "North", "Admin", "2bf0d5d5-7691-418f-b2f7-266c7467a0b0", "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png" },
                    { 2, new DateTime(2024, 2, 5, 13, 42, 2, 858, DateTimeKind.Local).AddTicks(4680), new DateTime(2024, 2, 5, 13, 42, 2, 858, DateTimeKind.Local).AddTicks(4681), "empty", "john@blazor.com", "John", "South", "User", "2bf0d5d5-7691-418f-b2f7-266c7467a0b1", "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png" },
                    { 3, new DateTime(2024, 2, 5, 13, 42, 2, 858, DateTimeKind.Local).AddTicks(4683), new DateTime(2024, 2, 5, 13, 42, 2, 858, DateTimeKind.Local).AddTicks(4683), "empty", "alice@blazor.com", "Alice", "West", "Admin", "2bf0d5d5-7691-418f-b2f7-266c7467a0b2", "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png" }
                });

            migrationBuilder.InsertData(
                table: "Reports",
                columns: new[] { "Id", "DateCreated", "Description", "ProductId", "ReportType", "ReportedProductId", "ReportedUserId", "ReporterUserId", "status" },
                values: new object[] { 1, new DateTime(2024, 2, 5, 13, 42, 2, 858, DateTimeKind.Local).AddTicks(5744), "Description", null, "site", null, null, 1, "unsolved" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 2, 5, 13, 42, 2, 858, DateTimeKind.Local).AddTicks(2860), "Test Purchase Chat", 1, null },
                    { 2, new DateTime(2024, 2, 5, 13, 42, 2, 858, DateTimeKind.Local).AddTicks(2886), "Test Swap Chat", null, 1 }
                });

            migrationBuilder.InsertData(
                table: "Ratings",
                columns: new[] { "Id", "DateCreated", "Description", "PurchaseId", "RatingValue", "SwapId", "UserId" },
                values: new object[] { 1, new DateTime(2024, 2, 5, 13, 42, 2, 858, DateTimeKind.Local).AddTicks(5408), "blahblah", 1, 4, null, 1 });

            migrationBuilder.InsertData(
                table: "Messages",
                columns: new[] { "Id", "ChatId", "DateCreated", "MessageContent", "SenderId" },
                values: new object[] { 1, 1, new DateTime(2024, 2, 5, 13, 42, 2, 858, DateTimeKind.Local).AddTicks(3224), "Fashion", 1 });
