    ...
    public partial class _123 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "2bf0d5d5-7691-418f-b2f7-266c7467a0b0", 0, "556bdd58-28b9-42b6-903e-0852089a9925", "frank@blazor.com", true, false, null, null, "FRANK@BLAZOR.COM", "FRANK@BLAZOR.COM", "AQAAAAIAAYagAAAAEL59q1K1Au66BvDn/u581/nluE6llYhYiFaSlwexj7vAmZzFxzmbw2zJP+Y3g37ZxA==", null, false, null, "454508df-a083-4a1d-9ee8-23de05dd2500", false, "frank@blazor.com" },
                    { "2bf0d5d5-7691-418f-b2f7-266c7467a0b1", 0, "d2f124fe-93c2-44dd-8af0-d384075ba525", "john@blazor.com", true, false, null, null, "JOHN@BLAZOR.COM", "JOHN@BLAZOR.COM", "AQAAAAIAAYagAAAAEEZVTqeD2N0Xfi9RP4Sryq1nzUl8dV96AQMba+y/yErdGMa94XfiIqJheoEdvFEgNg==", null, false, null, "ae57ff04-2dec-45c4-8bdf-027848af371d", false, "john@blazor.com" },
                    { "2bf0d5d5-7691-418f-b2f7-266c7467a0b2", 0, "b50a42f3-b724-40af-89f9-c7edf4a325a3", "alice@blazor.com", true, false, null, null, "ALICE@BLAZOR.COM", "ALICE@BLAZOR.COM", "AQAAAAIAAYagAAAAENXcQ9p7KX97LwW5ROMC0lVBtsjceDg1cqiyW0zIgWnrAANtnKp9bWvru9uICnmCTw==", null, false, null, "177dd96c-504a-410b-92a0-99bcc94abddc", false, "alice@blazor.com" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 1, 29, 11, 24, 51, 505, DateTimeKind.Local).AddTicks(5948), new DateTime(2024, 1, 29, 11, 24, 51, 505, DateTimeKind.Local).AddTicks(5951), "empty", "frank@blazor.com", "Frank", "North", "User", "2bf0d5d5-7691-418f-b2f7-266c7467a0b0", "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png" },
                    { 2, new DateTime(2024, 1, 29, 11, 24, 51, 505, DateTimeKind.Local).AddTicks(5955), new DateTime(2024, 1, 29, 11, 24, 51, 505, DateTimeKind.Local).AddTicks(5955), "empty", "john@blazor.com", "John", "South", "User", "2bf0d5d5-7691-418f-b2f7-266c7467a0b1", "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png" },
                    { 3, new DateTime(2024, 1, 29, 11, 24, 51, 505, DateTimeKind.Local).AddTicks(5957), new DateTime(2024, 1, 29, 11, 24, 51, 505, DateTimeKind.Local).AddTicks(5957), "empty", "alice@blazor.com", "Alice", "West", "Admin", "2bf0d5d5-7691-418f-b2f7-266c7467a0b2", "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png" }
                });

            migrationBuilder.InsertData(
                table: "Reports",
                columns: new[] { "Id", "DateCreated", "Description", "ProductId", "ReportType", "ReportedProductId", "ReportedUserId", "ReporterUserId", "status" },
                values: new object[] { 1, new DateTime(2024, 1, 29, 11, 24, 51, 505, DateTimeKind.Local).AddTicks(6826), "Description", null, "site", null, null, 1, "unsolved" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 1, 29, 11, 24, 51, 505, DateTimeKind.Local).AddTicks(5021), "Test Purchase Chat", 1, null },
                    { 2, new DateTime(2024, 1, 29, 11, 24, 51, 505, DateTimeKind.Local).AddTicks(5046), "Test Swap Chat", null, 1 }
                });

            migrationBuilder.InsertData(
                table: "Ratings",
                columns: new[] { "Id", "DateCreated", "Description", "PurchaseId", "RatingValue", "SwapId", "UserId" },
                values: new object[] { 1, new DateTime(2024, 1, 29, 11, 24, 51, 505, DateTimeKind.Local).AddTicks(6517), "blahblah", 1, 4, null, 1 });

            migrationBuilder.InsertData(
                table: "Messages",
                columns: new[] { "Id", "ChatId", "DateCreated", "MessageContent", "SenderId" },
                values: new object[] { 1, 1, new DateTime(2024, 1, 29, 11, 24, 51, 505, DateTimeKind.Local).AddTicks(5362), "Fashion", 1 });
