    ...
    public partial class fin : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "2bf0d5d5-7691-418f-b2f7-266c7467a0b0", 0, "7699b770-7eb4-4b80-81e1-f7445be891ba", "frank@blazor.com", true, false, null, null, "FRANK@BLAZOR.COM", "FRANK@BLAZOR.COM", "AQAAAAIAAYagAAAAEO4GIOXWfhSa+JxOyroJ9mCwKdz1mnO2Ux+a7RP754dd16gLUjWXIRzybI5ka/uIhw==", null, false, null, "9e00c058-ac37-41f2-8b4b-354922cb077f", false, "frank@blazor.com" },
                    { "2bf0d5d5-7691-418f-b2f7-266c7467a0b1", 0, "3a44f514-50cf-4980-a17b-5aa2e977c059", "john@blazor.com", true, false, null, null, "JOHN@BLAZOR.COM", "JOHN@BLAZOR.COM", "AQAAAAIAAYagAAAAENm7NzsWfee4oDmX4nhwXTdRTTQKKHS4nBSmhK+8EhBb+KPCVlpba9xVfoYJ/y/g9w==", null, false, null, "fadb2e80-c032-4831-abf7-844c5367dd66", false, "john@blazor.com" },
                    { "2bf0d5d5-7691-418f-b2f7-266c7467a0b2", 0, "362598cd-1424-4889-964d-c05332cbb985", "alice@blazor.com", true, false, null, null, "ALICE@BLAZOR.COM", "ALICE@BLAZOR.COM", "AQAAAAIAAYagAAAAEAPqzr1JgGGE4J2afSO+QHqsU8VMwpg1BbHDRLMivD52l0KKDDovGB5Vt84ykuPq8Q==", null, false, null, "e76b941b-77be-4913-9d6c-2de017a9560d", false, "alice@blazor.com" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 2, 3, 13, 54, 2, 228, DateTimeKind.Local).AddTicks(4235), new DateTime(2024, 2, 3, 13, 54, 2, 228, DateTimeKind.Local).AddTicks(4236), "empty", "frank@blazor.com", "Frank", "North", "User", "2bf0d5d5-7691-418f-b2f7-266c7467a0b0", "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png" },
                    { 2, new DateTime(2024, 2, 3, 13, 54, 2, 228, DateTimeKind.Local).AddTicks(4238), new DateTime(2024, 2, 3, 13, 54, 2, 228, DateTimeKind.Local).AddTicks(4239), "empty", "john@blazor.com", "John", "South", "User", "2bf0d5d5-7691-418f-b2f7-266c7467a0b1", "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png" },
                    { 3, new DateTime(2024, 2, 3, 13, 54, 2, 228, DateTimeKind.Local).AddTicks(4328), new DateTime(2024, 2, 3, 13, 54, 2, 228, DateTimeKind.Local).AddTicks(4328), "empty", "alice@blazor.com", "Alice", "West", "Admin", "2bf0d5d5-7691-418f-b2f7-266c7467a0b2", "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png" }
                });

            migrationBuilder.InsertData(
                table: "Reports",
                columns: new[] { "Id", "DateCreated", "Description", "ProductId", "ReportType", "ReportedProductId", "ReportedUserId", "ReporterUserId", "status" },
                values: new object[] { 1, new DateTime(2024, 2, 3, 13, 54, 2, 228, DateTimeKind.Local).AddTicks(5759), "Description", null, "site", null, null, 1, "unsolved" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 2, 3, 13, 54, 2, 228, DateTimeKind.Local).AddTicks(3200), "Test Purchase Chat", 1, null },
                    { 2, new DateTime(2024, 2, 3, 13, 54, 2, 228, DateTimeKind.Local).AddTicks(3229), "Test Swap Chat", null, 1 }
                });

            migrationBuilder.InsertData(
                table: "Ratings",
                columns: new[] { "Id", "DateCreated", "Description", "PurchaseId", "RatingValue", "SwapId", "UserId" },
                values: new object[] { 1, new DateTime(2024, 2, 3, 13, 54, 2, 228, DateTimeKind.Local).AddTicks(5201), "blahblah", 1, 4, null, 1 });

            migrationBuilder.InsertData(
                table: "Messages",
                columns: new[] { "Id", "ChatId", "DateCreated", "MessageContent", "SenderId" },
                values: new object[] { 1, 1, new DateTime(2024, 2, 3, 13, 54, 2, 228, DateTimeKind.Local).AddTicks(3652), "Fashion", 1 });
