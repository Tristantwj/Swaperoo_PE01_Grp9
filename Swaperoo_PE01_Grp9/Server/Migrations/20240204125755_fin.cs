    ...
    public partial class fin : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "2bf0d5d5-7691-418f-b2f7-266c7467a0b0", 0, "e3b0b1cc-d39e-4551-b8d4-da9c038fb69c", "frank@blazor.com", true, false, null, "FRANK@BLAZOR.COM", "FRANK@BLAZOR.COM", "AQAAAAIAAYagAAAAEDmARZ0OUt2kCDkeycW5fkI7++ioPtMx5Wo7RbbHgNWJfFugsggtynOrdncLyPrTog==", null, false, "1dc32ac3-b13b-4fe8-8c2b-ba7a4f21e74b", false, "frank@blazor.com" },
                    { "2bf0d5d5-7691-418f-b2f7-266c7467a0b1", 0, "dda8b206-6574-4e1b-9e97-a8bbc9c254db", "john@blazor.com", true, false, null, "JOHN@BLAZOR.COM", "JOHN@BLAZOR.COM", "AQAAAAIAAYagAAAAEC4yQqysLkUJapdctXccbaePeub9u3UxKkS5ueMQbcgsGkQ1tw4vH1RussqvPWCiiA==", null, false, "22db81a3-f671-4eb7-9adf-6876c6b9f9c1", false, "john@blazor.com" },
                    { "2bf0d5d5-7691-418f-b2f7-266c7467a0b2", 0, "50028b2d-1d83-4967-bd77-3bd2476a9a55", "alice@blazor.com", true, false, null, "ALICE@BLAZOR.COM", "ALICE@BLAZOR.COM", "AQAAAAIAAYagAAAAEJCHb/oBudi4XmEsBNEXsaKJNV2N1qWd5w/xCIXGrl3sdFxql/MnMEMfUW6MDIIDQQ==", null, false, "07010c20-0f06-4816-816e-cb4850b86767", false, "alice@blazor.com" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 2, 4, 20, 57, 55, 280, DateTimeKind.Local).AddTicks(2285), new DateTime(2024, 2, 4, 20, 57, 55, 280, DateTimeKind.Local).AddTicks(2287), "empty", "frank@blazor.com", "Frank", "North", "User", "2bf0d5d5-7691-418f-b2f7-266c7467a0b0", "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png" },
                    { 2, new DateTime(2024, 2, 4, 20, 57, 55, 280, DateTimeKind.Local).AddTicks(2289), new DateTime(2024, 2, 4, 20, 57, 55, 280, DateTimeKind.Local).AddTicks(2290), "empty", "john@blazor.com", "John", "South", "User", "2bf0d5d5-7691-418f-b2f7-266c7467a0b1", "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png" },
                    { 3, new DateTime(2024, 2, 4, 20, 57, 55, 280, DateTimeKind.Local).AddTicks(2292), new DateTime(2024, 2, 4, 20, 57, 55, 280, DateTimeKind.Local).AddTicks(2292), "empty", "alice@blazor.com", "Alice", "West", "Admin", "2bf0d5d5-7691-418f-b2f7-266c7467a0b2", "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png" }
                });

            migrationBuilder.InsertData(
                table: "Reports",
                columns: new[] { "Id", "DateCreated", "Description", "ProductId", "ReportType", "ReportedProductId", "ReportedUserId", "ReporterUserId", "status" },
                values: new object[] { 1, new DateTime(2024, 2, 4, 20, 57, 55, 280, DateTimeKind.Local).AddTicks(3750), "Description", null, "site", null, null, 1, "unsolved" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 2, 4, 20, 57, 55, 280, DateTimeKind.Local).AddTicks(1292), "Test Purchase Chat", 1, null },
                    { 2, new DateTime(2024, 2, 4, 20, 57, 55, 280, DateTimeKind.Local).AddTicks(1320), "Test Swap Chat", null, 1 }
                });

            migrationBuilder.InsertData(
                table: "Ratings",
                columns: new[] { "Id", "DateCreated", "Description", "PurchaseId", "RatingValue", "SwapId", "UserId" },
                values: new object[] { 1, new DateTime(2024, 2, 4, 20, 57, 55, 280, DateTimeKind.Local).AddTicks(2850), "blahblah", 1, 4, null, 1 });

            migrationBuilder.InsertData(
                table: "Messages",
                columns: new[] { "Id", "ChatId", "DateCreated", "MessageContent", "SenderId" },
                values: new object[] { 1, 1, new DateTime(2024, 2, 4, 20, 57, 55, 280, DateTimeKind.Local).AddTicks(1667), "Fashion", 1 });
